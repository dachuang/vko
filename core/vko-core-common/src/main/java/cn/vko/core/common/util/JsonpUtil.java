...
public class JsonpUtil {
	 ...
	 */
	public static String format(final String format, final Object... args) throws ParamException {
		return format(Locale.getDefault(), format, args);
	}

	public static String format(final String callback, final String json) throws ParamException {
		return format(Locale.getDefault(), CALLBACK_FOMART, callback, json);
	}
	 ...
	 * @throws DataException 如果格式存在异常，则提示DataException
	 */
	public static String format(final Locale locale, final String format, final Object... args) throws ParamException {
		if (isEmpty(format)) {
			return "";
		}
		if (args == null) {
	...
	public static void safeWrite(final HttpServletResponse resp, final String str) {
		if (resp == null) {
			return;
		}
		try {
	...
	public static void safeWrite(final Writer writer, final String str) {
		if (writer == null) {
			return;
		}
		try {
