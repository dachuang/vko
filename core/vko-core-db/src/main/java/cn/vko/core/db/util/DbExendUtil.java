...
public class DbExendUtil {
	...
	*/
	 ...
	 * @return 禁用条数
	 */
	public static <T extends IValidEntity> int disable(final IDbDao dao, final Class<T> clazz, final long... ids) {
	 ...
	 * @return 成功的条数
	 */
	public static int disable(final IDbDao dao, final String tableName, final long... ids) {
	 ...
	 * @return 成功的条数
	 */
	public static int disable(final IDbDao dao, final String tableName, final Condition cnd) {
	 ...
	 * @return 启用条数
	 */
	public static <T extends IValidEntity> int enable(final IDbDao dao, final Class<T> clazz, final long... ids) {
	 ...
	 * @return 成功的条数
	 */
	public static int enable(final IDbDao dao, final String tableName, final long... ids) {
	 ...
	 * @return 成功的条数
	 */
	protected static int enable(final IDbDao dao, final String tableName, final Condition cnd) {
	 ...
	 * @return 更新的行数
	*/
	private static <T> int updateStatus(final IDbDao dao, final String tableName, final boolean valid,
			final Condition cnd) {
