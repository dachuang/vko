...
import cn.vko.core.db.mock.entity.MockEntity4DbQuery;
import cn.vko.core.db.mock.entity.MockEntityWithAutoId;
import cn.vko.core.db.mock.entity.MockEntityWithoutAutoId;
import cn.vko.core.db.mock.entity.MockEntityWithoutId;
import cn.vko.core.db.util.RecordUtil;
...
public class TestDbDao {
	...
	*/
	@Test(expectedExceptions = ParamException.class)
	public void testExcuteNull() throws Exception {
		dbDao.excute();
	}
