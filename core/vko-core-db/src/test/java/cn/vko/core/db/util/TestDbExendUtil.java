...
public class TestDbExendUtil {
	...
	*/
	...
	public void testCount() throws Exception {
		assertEquals(totalQuerySize, DbExendUtil.count(dbDao, MockEntity4ExtendCount.class));
	}

	@Test
	public void testCountCnd() {
		int size = 50;
		assertEquals(size, DbExendUtil.count(dbDao, MockEntity4ExtendCount.class, Cnd.where("id", "<=", size)));
	}
	...
	public void testAbleSignleNoral() throws Exception {
		...
		DbExendUtil.disable(dbDao, MockEntity4Valid.class, entity.getId());
		MockEntity4Valid disableEntity = dbDao.fetch(MockEntity4Valid.class, entity.getId());
		assertFalse(disableEntity.isValid());
		DbExendUtil.enable(dbDao, MockEntity4Valid.class, entity.getId());
		MockEntity4Valid enableEntity = dbDao.fetch(MockEntity4Valid.class, entity.getId());
	...
	public void testAbleMulipt() {
		...
		DbExendUtil.disable(dbDao, MockEntity4Valid.class, entity1.getId(), entity2.getId());
		MockEntity4Valid disableEntity1 = dbDao.fetch(MockEntity4Valid.class, entity1.getId());
		MockEntity4Valid disableEntity2 = dbDao.fetch(MockEntity4Valid.class, entity2.getId());
		assertFalse(disableEntity1.isValid());
		assertFalse(disableEntity2.isValid());
		DbExendUtil.enable(dbDao, MockEntity4Valid.class, entity1.getId(), entity2.getId());

		MockEntity4Valid enableEntity1 = dbDao.fetch(MockEntity4Valid.class, entity1.getId());
		MockEntity4Valid enableEntity2 = dbDao.fetch(MockEntity4Valid.class, entity2.getId());
