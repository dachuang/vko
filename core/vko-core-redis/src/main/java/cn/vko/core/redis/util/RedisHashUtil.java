...
public final class RedisHashUtil {
	...
	*/
	public static long hincrBy(final IRedisDao dao, final String key, final String field, final long value) {
		checkDao(dao);
		if (!dao.exists(key)) {
			return -1;
		}
	...
	*/
	public static long hincrBy(final IRedisDao dao, final String key, final String field) {
		checkDao(dao);
		if (!dao.exists(key)) {
			return -1;
		}
	 ...
	 * {@link #hincrBy(IRedisDao, String, String, long)}
	*/
	public static long hdecrBy(final IRedisDao dao, final String key, final String field) {
