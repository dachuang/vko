...
public class RedisLatestUtil {
	 ...
	 * @return  >0 成功，<0 失败
	 */
	public static long add(final IRedisDao dao, final int number, final String key, final Object... values) {
		checkDao(dao);
	 ...
	 * @return  >0 成功，<0 失败
	 */
	public static long addMax(final IRedisDao dao, final String key, final Object... values) {
	 ...
	 * @return  >0 成功，<0 失败
	 */
	public static long addMax(final IRedisDao dao, final String key, final List<?> ids) {
		checkDao(dao);
	 ...
	 * @return  >0 成功，<0 失败
	 */
	public static long add(final IRedisDao dao, final int number, final String key, final List<?> ids) {
		checkDao(dao);
		String realKey = key(TOP, key);
		if (isEmpty(ids)) {
			return 0;
	 ...
	 * @return List泛型数组
	 */
	public static List<String> query(final IRedisDao dao, final String key, final int offset, final int count) {
		checkDao(dao);
	 ...
	 * @param dao 
	 * @param key 键值
	 * @param values 移除的成员集合
	 * @return 移除的个数
	 */
	public static long lrem(final IRedisDao dao, final String key, final Object... values) {
		checkDao(dao);
		String realKey = key(TOP, key);
		if (isEmpty(values)) {
			return 0;
