...
public final class RedisLiveUtil {
	 ...
	 * @return 放入的个数
	 */
	public static long add(final IRedisDao dao, final String key, final double score, final String member) {
		checkDao(dao);
	 ...
	 * @return 数据是否存在
	 */
	public static boolean isLive(final IRedisDao dao, final String key, final String member) {
		checkDao(dao);
	 ...
	 * @return 被移除的成员数量
	 */
	public static long rm(final IRedisDao dao, final String key, final String... members) {
		checkDao(dao);
	 ...
	 * @return 过期成员列表
	 */
	public static Set<String> outDate(final IRedisDao dao, final String key, final double min, final double max) {
		checkDao(dao);
