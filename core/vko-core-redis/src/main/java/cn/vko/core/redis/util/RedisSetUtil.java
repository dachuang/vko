...
public class RedisSetUtil {
	 ...
	 * @return 放入的个数
	 */
	public static long add(final IRedisDao dao, final String key, final String... members) {
		checkDao(dao);
	 ...
	 * @return 是否是成员
	 */
	public static boolean isMember(final IRedisDao dao, final String key, final String member) {
		checkDao(dao);
	...
	* @param dao redisDao
	 ...
	 * @param dao redisDao
	 * @param key 键
	 * @param members 待移出的成员
	 * @return 移出的个数
	 */
	public static long rem(final IRedisDao dao, final String key, final String... members) {
		checkDao(dao);
