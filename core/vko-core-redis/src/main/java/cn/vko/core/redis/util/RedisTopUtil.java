...
public final class RedisTopUtil {
	 ...
	 * 如果某个 member已经是有序集的成员，那么更新这个 member 的 score 值，并通过重新插入这个 member 元素，来保证该 member 在正确的位置上。<br/>
	...
	*/
	public static long zadd(final IRedisDao dao, final String key, final double score, final String member) {
		checkDao(dao);
	...
	*/
	public static long zrem(final IRedisDao dao, final String key, final String... members) {
		checkDao(dao);
	...
	*/
	public static long zrank(final IRedisDao dao, final String key, final String member) {
		checkDao(dao);
	...
	*/
	public static double zscore(final IRedisDao dao, final String key, final String member) {
		checkDao(dao);
	 ...
	 * @return 成员的新 score 值
	*/
	public static double zincrby(final IRedisDao dao, final String key, final double score, final String member) {
	...
	*/
	public static Set<String> zrange(final IRedisDao dao, final String key, final long start, final long end) {
		checkDao(dao);
	 ...
	 * 如果 member 不是有序集 key 的成员，返回 nil 。
	*/
	public static Set<String> zrange(final IRedisDao dao, final String key, final long end) {
