...
import cn.vko.core.web.www.tld.support.TagUtil;
...
public class AjaxPageTag extends PageTag {
	...
	/**
	 * 页面样式，目前支持 1 link,2 more(点击获取更多),3 左右,4 scroll(向下滚动获取更多)
	 */
	...
	protected String getCss() {
		if (Util.isEmpty(getCssName())) {
			return AJAX_CSSNAME;
		}
		return AJAX_CSSNAME + " " + getCssName();
	}
}
