...
import cn.vko.core.db.entity.ITreeEntity;
import cn.vko.core.db.util.DbSqlUtil;
import cn.vko.core.web.form.IAddForm;
import cn.vko.core.web.form.IModForm;
import cn.vko.core.web.form.IQueryForm;
import cn.vko.core.web.form.ISqlForm;
...
public class FormUtil {
	...
	*/
	 ...
	 * @return map对象
	 */
	public static Map<String, Object> query(final IDbDao dbDao, final ISqlForm sqlForm, final Pager pager) {
		checkNull(sqlForm, "sqlForm不能为空");
		Map<String, Object> map = query(dbDao, sqlForm.createPagerSql(dbDao), sqlForm.createCountSql(dbDao), pager);
	 ...
	 * @return 节点和顺序号的map
	 */
	public static <T extends ITreeEntity> Map<String, Object> fetchParent(final DbDao dbDao, final Class<T> clazz,
			final long id) {
		checkNull(dbDao, "dbDao对象不能为空");
