...
public class RequestUtil {
	 ...
	 * 
	 * @param request 请求
	 * @return 例如，URL：http://www.vko.cn/myhome.html，返回结果：/myhome.html<br>
	 * 			或者，URL：http://www.vko.cn/，返回：/
	 */
	...
	public static void redirectTo(final HttpServletRequest request, final HttpServletResponse resp, final String url,
		...
		redirectUrl.append(REDIRECT_FROM_KEY).append("=").append(EncodeUtil.urlEncode(oldUrl));
		if (th != null) {
			redirectUrl.append("&").append(REDIRECT_ERROR_KEY).append("=")
					.append(EncodeUtil.urlEncode(ExceptionUtil.getSimpleMessage(th)));
		}
		try {
