...
public class WeeTuiCaptchaServiceTest
{
    private VkoCaptchaService service;

    @Before
    public void prepare()
        throws Exception
    {
        ApplicationContext ctx = new ClassPathXmlApplicationContext( "applicationcontext-vko-captcha.xml" );
        service = (VkoCaptchaService) ctx.getBean( "vkoCaptchaService" );
    }
