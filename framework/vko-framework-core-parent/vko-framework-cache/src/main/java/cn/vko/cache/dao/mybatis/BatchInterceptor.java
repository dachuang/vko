...
import cn.vko.cache.dao.mybatis.ext.BatchExecutorExt;
import cn.vko.cache.dao.mybatis.ext.MapperProxyExt;
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (batch != null) {
			...
			if ("update".equals(invocation.getMethod().getName())) {
				return update(invocation, iterator);
			} else {
				//查询
				return query(invocation, iterator);
			}
		}
		return invocation.proceed();
