...
import cn.vko.cache.dao.ha.IHADataSourceCreator;
import cn.vko.cache.dao.ha.NonHADataSourceCreator;
...
public class DefaultDataSourceService implements IDataSourceService, InitializingBean {
	...
	private List<DataSource> writeDataSources = new ArrayList<DataSource>();
