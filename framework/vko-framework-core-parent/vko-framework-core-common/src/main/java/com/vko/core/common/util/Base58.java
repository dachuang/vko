...
public class Base58 {
	...
	public static byte[] decodeChecked(String input) {
		...
		if (tmp.length < 4) {
			throw new RuntimeException("Input to short");
		}
	...
	public static void main(String[] args) {
		...
		byte[] byUuid = new byte[8];
		//fY4qotsRvW
		//W71pW2B1xB
		long2bytes(1L, byUuid, 0);
		System.out.println(Base58.encode(byUuid));
		System.out.println(Rad62.TentoN(1L, 62));
		System.out.println(Base32.encode(1L));
		System.out.println(Base32.encode(1000L));
		System.out.println(Base32.encode(1000000000001L));
		System.out.println(Base32.encode(1002L));
		System.out.println(Base32.encode(1003L));
		System.out.println(Base32.encode(1004L));
		System.out.println(Base32.encode(1005L));
		System.out.println(Base32.encode(1006L));
		System.out.println(Base32.encode(1007L));
		System.out.println(Base32.encode(1008L));
		System.out.println(Base32.encode(1009L));
		System.out.println(Base62.encode(1L));
		long start = System.currentTimeMillis();
		for (int i = 0; i < 100000; i++) {
			Base58.encode(byUuid);
		}
		long end = System.currentTimeMillis();
		System.out.println(end - start);
		start = System.currentTimeMillis();
		for (int i = 0; i < 100000; i++) {
			Rad62.TentoN(216172290216177664L, 62);
		}
		...
		start = System.currentTimeMillis();
		for (int i = 0; i < 100000; i++) {
			Base32.encode(216172290216177664L);
		...
		start = System.currentTimeMillis();
		for (int i = 0; i < 100000; i++) {
			Base62.encode(216172290216177664L);

		}
		end = System.currentTimeMillis();
		System.out.println(end - start);
		System.out.println("AAAAAAAAAAB64".compareTo("AAAAAAAAAAB66"));
	}
}
