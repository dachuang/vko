...
public class PageThumUtil {
	 ...
	 * 截取网页图片，并且生成缩略图
	 * 
	 * /usr/local/cutycapt/xvfb-run.sh --server-args="-screen 0, 1024x768x24" /usr/local/cutycapt/CutyCapt --url=http://miyoo.cn --out=163.jpg
	 * 
	 * //convert截取第一屏
	 * convert -crop  1024x768+0+0 /home/163.jpg  /home/163_fs.jpg
	 * 
	 * //convert缩放第一屏
	 * convert -resize 20%x20% /home/163.jpg /home/163a4._20_20.jpg
	 * 
	 * @param run linux下的执行脚本  /usr/local/cutycapt/xvfb-run.sh
	 * @param cutycapt linux下的截图命令 /usr/local/cutycapt/CutyCapt
	 * @param site 网站地址: http://miyoo.cn/
	 * @param dest 目标图片文件保存目录  /home/163.jpg
	 */
	...
	public static void main(String[] args) {
		PageThumUtil.transfer("/usr/local/cutycapt/xvfb-run.sh", "/usr/local/cutycapt/CutyCapt", "http://miyoo.cn", "/home/163_fs.jpg");
	}
}
