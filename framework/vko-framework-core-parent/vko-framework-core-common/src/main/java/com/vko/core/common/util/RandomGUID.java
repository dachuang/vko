...
public class RandomGUID extends Object {
	...
	public static RandomGUID fromString(String name) {
		...
		return new RandomGUID(CompressEncodeing.unCompressNumber(strArray[0]),
				CompressEncodeing.unCompressNumber(strArray[1]), CompressEncodeing.unCompressNumber(strArray[2]),
				CompressEncodeing.unCompressNumber(strArray[3]));
	}
