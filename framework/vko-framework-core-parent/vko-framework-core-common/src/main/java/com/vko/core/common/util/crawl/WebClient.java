package com.vko.core.common.util.crawl;
...
public class WebClient {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	String s = GetWebContent("http://www.36kr.com/page/1", "utf-8"); 
    		//String s = GetWebContent("http://www.36kr.com/p/146196.html", "utf-8");
