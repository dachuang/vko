...
public final class DefaultFilterInvocation implements FilterInvocation {
	...
	public DefaultFilterInvocation(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
			FilterInterceptor[] interceptor, ServletContext context) {
