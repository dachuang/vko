...
public class CookieSerializeImpl implements SessionSerialize {
	...
	// }
	public static void main(String[] args) {
		//		ObjectSerialize encodeAndDecode = (new Base64Operation(new TeaOperation(new LZ4Operation(new JSONOperation()))));
		...
		//		HashMap<String, Object> ddd =(HashMap<String, Object>)encodeAndDecode.deSerialize(ff);
		//		
