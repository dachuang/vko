...
<div id="header">
	<div class="header">
    	<div class="logo">
        	<h1>微课网</h1>
        	<span><a href="${vgc.www}" title="微课网"><img src="${static}/vko/images/logo/logo.jpg" width="194" height="57" alt="微课网" /></a></span>
        </div>
        ...
        <div class="nav">
            ...
            <li><a target="_blank" href="${vgc.course}" title="课程">课程</a></li>
            <li><a target="_blank" href="${vgc.group}" title="群组">群组</a></li>
            <li><a target="_blank" href="${vgc.teacher}" title="名师">名师</a></li>
           <li><a target="_blank" href="${vgc.zao}" title="小灶">小灶</a></li>
            </ul>
            <div class="search">
