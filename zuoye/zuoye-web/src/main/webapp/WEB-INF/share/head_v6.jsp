...
<div id="header">
	<div class="header">
    	<div class="logo"> 
        	...
        	<%
        		String logo="http://static.vko.cn/vko/images/logo/logo.jpg";
        		...
        		if(obj!=null && !obj.toString().trim().equals("") && !obj.toString().trim().equals("null"))
        		{
        			...
        			if(type.equals("6"))
        			{
        				logo="http://static.vko.cn/vko/images/logo/zxs_logo.png";
        			}else if(type.equals("8"))
        			{//四联微课用户
        				logo="http://static.vko.cn/vko/images/logo/slvko_logo.png";
        			}
        		}
        	%>
        	
        	<span><a href="${vgc.www}" title="微课网"><img src="<%=logo %>" width="194" height="57" alt="微课网" /></a></span>
        </div>
        
        <div class="online">你正在和<b id="userCount">-</b>名同学一起，学习、交流、互动、进步...</div>
        
        <div class="contact"><img width="133" height="19" alt="微课网客服电话：4008-900-800" src="${static}/vko/images/logo/tel_400.jpg" /></div>
        
        <div class="nav">
            <ul id="home_nav_item">
            <li><a class="home" href="${vgc.www}/myhome.html">我的微课</a></li>   
            <li><a target="_blank" href="${vgc.course}" title="课程频道">课程</a></li>  
            <li><a target="_blank" href="${vgc.group}" title="群组频道">群组</a></li>
            <li><a target="_blank" href="${vgc.tiku}" title="题库频道">题库</a></li>
            <li><a target="_blank" href="${vgc.teacher}" title="名师频道">名师</a></li>
           	<li><a target="_blank" href="${vgc.zao}" title="小灶频道">小灶</a></li>
           	<li><a target="_blank" href="${vgc.activity}" title="活动">活动</a></li>
            </ul>
            <div class="search">
            	<input type="text" value="<c:if test="${not empty keyword }">${keyword }</c:if>" placeholder="请输入关键字" id="allSearchText" keyVal="<c:if test="${not empty keywordEscape }">${keywordEscape}</c:if>"/>
              <input class="btn-search btn-allSearch" type="button" value="搜索"/>
            </div>
        </div>
    </div>
</div>